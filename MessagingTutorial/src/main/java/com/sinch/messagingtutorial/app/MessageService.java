...
public class MessageService extends Service implements SinchClientListener {
    ...
    private static final String APP_KEY = "8f417dda-0089-451b-9a96-e73de3ca33ee";
    private static final String APP_SECRET = "3PNGi+X/rEKewn//ktJvEw==";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        user=ParseUser.getCurrentUser().toString();
